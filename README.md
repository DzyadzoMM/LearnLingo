...
1. За допомогою [firebase_DB](https://firebase.google.com/) додати до застосунку можливість авторизації (реєстрація, логінізація, отримання даних про поточного користувача, логаут). 
...
Для наповнення колекції можна використовувати [teachers.json](https://drive.google.com/file/d/121ufnYEerBdPopSSVw0W7iUJWT-4Zcfu/view?usp=sharing) 

## 4. Відповідно до [макету](https://www.figma.com/file/dewf5jVviSTuWMMyU3d8Mc/%D0%9F%D0%B5%D1%82-%D0%BF%D1%80%D0%BE%D1%94%D0%BA%D1%82-%D0%B4%D0%BB%D1%8F-%D0%9A%D0%A6?type=design&node-id=0-1&mode=design&t=jCmjSs9PeOjObYSc-0) реалізувати картку з описом характеристик викладача. 
...
2. Додай фільтрацію: за мовою викладання; за рівнем знань учнів, з якими 

працює викладач; за ціною за годину заняття. 
...
[firebase_docs](https://firebase.google.com/docs/reference) - документація firebase для роботи з REST 
